...
public class CreateLevelSelectScene : MonoBehaviour
{
    [ContextMenu("Create LevelSelect Scene")]
    public void CreateScene()
    {
        ...
        // Create Back Button
        GameObject backButtonGO = CreateBackButton(canvas.transform);
        
        // Populate levels directly (no runtime setup needed)
        PopulateLevelsDirectly(content, levelItemPrefab);
        
        // Create LevelSelectSceneManager (for future updates)
        GameObject managerGO = new GameObject("LevelSelectSceneManager");
        LevelSelectSceneManager manager = managerGO.AddComponent<LevelSelectSceneManager>();
        ...
        manager.backButton = backButtonGO.GetComponent<Button>();
        
        // Save scene
        UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, "Assets/Scenes/LevelSelect.unity");
        
        Debug.Log("LevelSelect scene created successfully!");
    }
    ...
    private GameObject CreateBackButton(Transform parent)
    {
        ...
        backButton.onClick.AddListener(() => {
            FindObjectOfType<LevelSelectSceneManager>().OnBackButtonClicked();
        });
