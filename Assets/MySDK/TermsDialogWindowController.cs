...
public class TermsDialogWindowController : MonoBehaviour
{
    ...
    /// <summary>
    /// Initialize the WebView component for displaying terms of service
    /// </summary>
    private void InitializeWebView()
    {
        ...
        GameObject webViewGO = new GameObject("TermsWebView");
        ...
        // Configure the WebView to load Terms of Service
        ...
        Debug.Log("WebView initialized for terms of service display");
    }
    ...
    private void RemoveScrollViewComponents()
    {
        ...
        {
            Debug.Log("Removing Scroll View component (Terms) - replacing with WebView");
        ...
        foreach (ScrollRect scrollRect in scrollRects)
        {
            ...
            {
                Debug.Log("Removing ScrollRect component (Terms) - replacing with WebView");
